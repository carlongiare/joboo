...
import com.client.brain.databinding.ActivityAppIntro2Binding;
import com.client.brain.preferences.SharedPrefrence;
import com.client.brain.ui.adapter.AppIntroPagerAdapter;
...
public class AppIntro extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    int[] mResources = {R.drawable.nearby, R.drawable.usingphone, R.drawable.expert};
