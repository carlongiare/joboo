...
public interface Consts {
    ...
    String PAYMENT_SUCCESS = BACKEND + "/Stripe/Payment/success";
    String MAKE_PAYMENT = BACKEND + "/Stripe/Payment/make_payment/";

    String PAYMENT_FAIL_Paypal = BACKEND + "/Webservice/payufailure";
    String PAYMENT_SUCCESS_paypal =BACKEND + "/Webservice/payusuccess";
    String MAKE_PAYMENT_paypal = BACKEND + "/Webservice/paypalWallent?";

    String INVOICE_PAYMENT_FAIL_Stripe = BACKEND + "/Stripe/BookingPayement/fail";
    String INVOICE_PAYMENT_SUCCESS_Stripe = BACKEND + "/Stripe/BookingPayement/success";
    String INVOICE_PAYMENT_Stripe = BACKEND + "/Stripe/BookingPayement/make_payment/";

    String INVOICE__PAYMENT_paypal = BACKEND + "/Webservice/paypal?";
    String PRIVACY_URL = BACKEND + "/Webservice/privacy";
    String TERMS_URL = BACKEND + "/Webservice/term";
    ...
    static final String mBroadcastShowAdd = "Joboo Client.showAdd";
    /*app data*/
