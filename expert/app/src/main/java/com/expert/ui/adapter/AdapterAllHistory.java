...
import com.expert.R;
import com.expert.databinding.AdapterAllBookingsBinding;
...
import com.expert.ui.fragment.History;
...
public class AdapterAllHistory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private String TAG = AdapterAllHistory.class.getSimpleName();
    private History newBookings;
    ...
    public AdapterAllHistory(History newBookings, ArrayList<ArtistBooking> artistBookingsList, UserDTO userDTO, LayoutInflater myInflater) {
